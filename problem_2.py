...
def problem_1():
    ...
    def gui_input():
        ...
        app.addImage('picture', 'benchpress.gif')
        app.stopFrame()
        ...
        app.addLabel("bench press simulation", "Bench Press Simulation")
        ...
        def onpress(button):
            ...
            '''
            if button == 'Pectoralis Muscle Force':
            ...
            elif button == 'Pectoralis Muscle Stress':
            ...
            elif button == 'Volumetric turnover in Lungs':
                pass


            elif button == 'Arterial shear stress':
                '''
            ...
            elif button == 'Stresses during exercise':

                '''
                Finds shoulder joint stresses in X,Y, muscle stresses, tendon, ligament stresses in total
                (separate graphs for tendons, ligaments ?)
        ...
        app.addButtons(["Muscle & Joint forces", "Muscle & Joint stresses" ], onpress)
